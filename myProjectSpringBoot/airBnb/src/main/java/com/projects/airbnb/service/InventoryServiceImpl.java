...
public class InventoryServiceImpl implements InventoryService {
    ...
    public Page<HotelDto> searchHotels(HotelSearchRequest hotelSearchRequest) {
        ...
        Page<Hotel> hotelWithAvailableInventory = inventoryRepository.findHotelWithAvailableInventory(
        ...
        return hotelWithAvailableInventory.map(element -> modelMapper.map(element, HotelDto.class));
    }
}
